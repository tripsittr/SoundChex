...
class TransferPathTest extends TestCase
{
    ...
    public function test_a_large_file_is_asked_for_in_pieces(): void
    {
        ...
        // never grew past its first. Measured against the real link, the
        // connection gives out at about 34 seconds however much is
        // outstanding - 952 MB delivered 27 MB, a 50 MB range delivered 25 MB,
        // and a 20 MB range completed in 28s. A time limit, not a size limit.
        //
        // So each attempt asks for a piece it can finish, and a piece that
        // lands is progress that survives.
        $asked = [];
