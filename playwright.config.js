...
export default defineConfig({
    ...
    projects: [
        ...
        { name: 'mobile', use: { ...devices['iPhone 13'] }, testMatch: /(mobile|phone|phone-dl|download-queue|downloads-remove|downloads-batch|mobile-touch|connection-toast|download-logging|player-session|failover)\.spec\.js/ },
    ],
